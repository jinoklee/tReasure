...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: install the required package for tReasure
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
for /r "%USERPROFILE%\Documents\tReasure_v1" %%F in (*pkg_lib.R*) do (
 echo %%~fF
 set "pkg=%%~fF"
 "%full%" "%%~fF" %*
)
...
$olnk.Arguments = '%USERPROFILE%\Documents\tReasure_v1\tReasure.R';^
